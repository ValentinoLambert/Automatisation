...
export default function PropertyForm() {
    ...
    function getBase64FromFileList(fileList) {
        const filePromises = Array.from(fileList).map((file) => new Promise((resolve, reject) => {
    ...
    const onHandleSave = (e) => {
        e.preventDefault();
        const data = property;
        data.options = optionsSelected?.map((option) => parseInt(option.value, 10));
                    ...
                    <form onSubmit={(e) => onHandleSave(e)}>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="flex items-center justify-center w-full">
                                <label htmlFor="images" className="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50" aria-label="Upload images">
                                    ...
                                    {property.images.map((item) => (
                                        item.type !== 'delete' && (
                                            <div className="relative" key={item.id}>
                                                <img className="w-full  rounded-lg" src={item.link} alt={`Property preview ${item.id}`} />
